...
$('pageNumber" + ClientID + @"').innerHTML = pageNumberCount" + ClientID + @" + ' of ' +  responseParsed" + ClientID + @".PageNumbers;
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            var enabledState = (Sitecore.Context.User!=null & Sitecore.Context.User.IsAdministrator)||(Sitecore.Context.Item!=null && Sitecore.Context.Item.Access.CanWrite());
            output.Write("<input type=\"text\" width=\"100%\" class=\"scIgnoreModified\" style=\"color:gray\" value=\"Type here to search\" id=\"filterBox" + this.ClientID + "\" style=\"width:100%\" " +  ( enabledState? "" : "disabled") +">");
